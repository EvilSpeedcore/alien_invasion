...
class Ship():
    ...
    def __init__(self, ai_settings, screen):
        ...
        self.original_image = pygame.image.load('images/ship_up.png')
        self.original_image_up_right = pygame.image.load('images/ship_up_right.png')
        self.original_image_up_left = pygame.image.load('images/ship_up_left.png')
        self.original_image_down_right = pygame.image.load('images/ship_down_right.png')
        self.original_image_down_left = pygame.image.load('images/ship_down_left.png')
        self.original_image_right = pygame.image.load('images/ship_right.png')
        self.original_image_left = pygame.image.load('images/ship_left.png')
        self.original_image_down = pygame.image.load('images/ship_down.png')
