...
class BlackHole(Sprite):
    ...
    def __init__(self, ai_settings, screen, ship):
        ...
        # Directory, which store black hole images.
        self.img_dir = path.join(path.dirname(__file__), 'images', 'black_hole')
        ...
        self.image = pygame.image.load('images/black_hole/black_hole_1.png')
    ...
    def prepare_images(self):
        ...
        for image in self.rt_list:
            self.images.append(pygame.image.load(path.join(self.img_dir, image)))
